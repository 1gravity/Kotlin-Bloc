...
public class ActivityCounterSimpleBindingImpl extends ActivityCounterSimpleBinding implements com.onegravity.bloc.generated.callback.OnClickListener.Listener {
    ...
    public ActivityCounterSimpleBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private ActivityCounterSimpleBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback9 = new com.onegravity.bloc.generated.callback.OnClickListener(this, 2);
        mCallback8 = new com.onegravity.bloc.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((com.onegravity.bloc.counter.CounterSimpleViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable com.onegravity.bloc.counter.CounterSimpleViewModel Viewmodel) {
    ...
    protected void executeBindings() {
        ...
        com.onegravity.bloc.counter.CounterSimpleViewModel viewmodel = mViewmodel;
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.decrement.setOnClickListener(mCallback9);
            this.increment.setOnClickListener(mCallback8);
        }
    }
