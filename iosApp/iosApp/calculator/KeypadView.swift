        ...
        return VStack(spacing: 8) {
            ...
            HStack(spacing: 8) {
                Button(action: {
                    ...
                    Text(text).textStyle(ButtonStyle(buttonSize: buttonSize))
                }
                Button(action: {
                ...
                Button(action: {
                    ...
                    Text(text).textStyle(ButtonStyle(backgroundColor: Color(red:0.61, green:0.15, blue:0.69, opacity: 1.0), textColor: Color.white, buttonSize: buttonSize))
                }
            }
            ...
            HStack(spacing: 8) {
                ...
                Button(action: {
                    ...
                    Text(text).textStyle(ButtonStyle(backgroundColor: Color(red:0.96, green:0.26, blue:0.21, opacity: 1.0), textColor: Color.white, buttonSize: buttonSize))
                }
            }
            ...
            HStack(spacing: 8) {
                ...
                Button(action: {
                    ...
                    Text(text).textStyle(ButtonStyle(backgroundColor: Color(red:0.01, green:0.66, blue:0.96, opacity: 1.0), textColor: Color.white, buttonSize: buttonSize))
                }
            }
            ...
            HStack(spacing: 8) {
                ...
                Button(action: {
                    ...
                    Text(text).textStyle(ButtonStyle(backgroundColor: Color(red:1.00, green:0.60, blue:0.00, opacity: 1.0), textColor: Color.white, buttonSize: buttonSize))
                }
            }
            ...
            HStack(spacing: 8) {
                ...
                Button(action: {
                    ...
                    Text(text).textStyle(ButtonStyle(backgroundColor: Color(red:0.30, green:0.69, blue:0.31, opacity: 1.0), textColor: Color.white, buttonSize: buttonSize))
                }
            }
